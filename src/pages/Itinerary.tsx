...
const Itinerary = () => {
  ...
  const generateItinerary = async () => {
    ...
    try {
      // Enhanced prompt for all users
      const premiumContext = "Include hidden gems, premium restaurant recommendations, luxury hotels, and exclusive local experiences.";
